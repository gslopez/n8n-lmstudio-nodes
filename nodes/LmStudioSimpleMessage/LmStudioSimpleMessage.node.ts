        ...
        properties: [
            {
                ...
                description:
                    'The model identifier to use. Models are fetched from your LM Studio server. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
            },
            {
                displayName: 'Message',
                name: 'message',
    ...
    async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            try {
                ...
                const jsonSchemaStr = this.getNodeParameter(
                    'jsonSchema',
                    itemIndex,
                    '{}',
                ) as string;
